...
/**
 * 提供经纬度和UTM之间相互转换及相关工具方法，其中MGRS不可用
 */
public class CoordinateSysConversion {

    public CoordinateSysConversion() {}
    ...
    public UTM latLon2UTM(double latitude, double longitude) {
    ...
    private class LatLon2UTM {
        public UTM convertLatLonToUTM(double latitude, double longitude) {
            ...
            retval.zone = longZone;
            retval.band = latZone;
            retval.easting = (int) _easting;
            retval.northing = (int) _northing;
